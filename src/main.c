...
static const Theme g_themes[] = {
    /* --- Core Defaults --- */
    /* 0: Editorial Dark — the default. Warm grays + copper-amber accent. */
    { "Editorial Dark",
    ...
    /* Default Dark — the original palette */
    { "Default Dark",
    ...
    /* Light — clean office light theme */
    { "Light",
    ...
    /* Flexoki Dark — inky warm paper for focused writing */
    { "Flexoki Dark",
        { 16,  15,  15, 255}, {206, 205, 195, 255}, {218, 112,  44, 255},
        {135, 154,  57, 255}, { 67, 133, 190, 255},
        { 40,  39,  38, 255}, {135, 133, 128, 255},
        { 24,  23,  23, 255}, { 40,  39,  38, 255}, { 52,  51,  49, 255},
        { 20,  19,  19, 255}, {135, 133, 128, 255},
        { 64,  60,  56, 180}, {208, 162,  21, 255},
    },
    /* Flexoki Light — warm paper tone for long reading sessions */
    { "Flexoki Light",
        {255, 252, 240, 255}, { 16,  15,  15, 255}, {188,  82,  21, 255},
        {102, 128,  11, 255}, { 32,  94, 166, 255},
        {242, 240, 229, 255}, {135, 133, 128, 255},
        {242, 240, 229, 255}, {230, 228, 217, 255}, {218, 216, 206, 255},
        {242, 240, 229, 255}, {135, 133, 128, 255},
        {218, 216, 206, 180}, {188,  82,  21, 255},
    },
    /* Gruvbox Dark — retro groove warm earth tones */
    { "Gruvbox Dark",
    ...
    /* Gruvbox Light — warm parchment and earthy retro groove */
    { "Gruvbox Light",
        {251, 241, 199, 255}, { 60,  56,  54, 255}, {175,  58,   3, 255},
        {121, 116,  14, 255}, {  7, 102, 120, 255},
        {235, 219, 178, 255}, {146, 131, 116, 255},
        {242, 229, 188, 255}, {235, 219, 178, 255}, {213, 196, 161, 255},
        {235, 219, 178, 255}, {124, 111, 100, 255},
        {213, 196, 161, 180}, {204,  36,  29, 255},
    },
    /* Solarized Dark */
    { "Solarized Dark",
    ...
    /* Ayu Mirage — slate blue-gray with warm radiant accents */
    { "Ayu Mirage",
        { 31,  36,  48, 255}, {203, 209, 222, 255}, {255, 204, 102, 255},
        {184, 204,  82, 255}, { 89, 194, 255, 255},
        { 39,  44,  58, 255}, {112, 122, 140, 255},
        { 25,  29,  39, 255}, { 39,  44,  58, 255}, { 50,  56,  74, 255},
        { 25,  29,  39, 255}, {112, 122, 140, 255},
        { 50,  56,  74, 180}, {255, 180,  84, 255},
    },
    ...
    /* High Contrast Dark — pure black and white */
    { "High Contrast Dark",
    ...
    /* High Contrast Light — pure white and black */
    { "High Contrast Light",
    ...
    /* --- Dark Coding Classics --- */
    /* Nord — cool arctic slate and frost accents */
    { "Nord",
    ...
    /* Dracula — deep violet-gray, high-chroma accents */
    { "Dracula",
    ...
    /* One Dark — muted slate, warm headings */
    { "One Dark",
    ...
    /* Kanagawa Wave — Japanese woodblock ink and water */
    { "Kanagawa Wave",
        { 31,  31,  40, 255}, {220, 215, 186, 255}, {230, 195, 132, 255},
        {118, 148, 106, 255}, {126, 156, 216, 255},
        { 42,  42,  55, 255}, {114, 113, 105, 255},
        { 22,  22,  29, 255}, { 42,  42,  55, 255}, { 54,  54,  70, 255},
        { 22,  22,  29, 255}, {147, 138, 169, 255},
        { 45,  79, 103, 180}, {228, 104, 118, 255},
    },
    /* Everforest Dark — low-saturation forest greens */
    { "Everforest Dark",
    ...
    /* Andromeda — deep space nebula with vibrant green and magenta */
    { "Andromeda",
        { 35,  38,  46, 255}, {213, 216, 224, 255}, {  0, 232, 152, 255},
        {249,  38, 114, 255}, {  0, 201, 255, 255},
        { 43,  47,  56, 255}, {116, 127, 143, 255},
        { 27,  30,  36, 255}, { 43,  47,  56, 255}, { 58,  64,  78, 255},
        { 27,  30,  36, 255}, {  0, 232, 152, 255},
        { 58,  64,  78, 180}, {249,  38, 114, 255},
    },
    /* Vesper — minimalist dark canvas with glowing amber */
    { "Vesper",
        { 16,  16,  16, 255}, {255, 255, 255, 255}, {255, 199, 153, 255},
        {153, 153, 153, 255}, {255, 160, 102, 255},
        { 27,  27,  27, 255}, {128, 128, 128, 255},
        { 10,  10,  10, 255}, { 27,  27,  27, 255}, { 45,  45,  45, 255},
        { 10,  10,  10, 255}, {255, 160, 102, 255},
        { 45,  45,  45, 190}, {255, 160, 102, 255},
    },

    /* --- Ocean & Navy Blues --- */
    /* Night Owl — deep midnight navy with pastel accents */
    { "Night Owl",
        {  1,  22,  39, 255}, {214, 222, 235, 255}, {199, 146, 234, 255},
        {173, 219, 103, 255}, {130, 170, 255, 255},
        { 11,  41,  66, 255}, { 99, 119, 119, 255},
        {  1,  18,  33, 255}, { 15,  37,  55, 255}, { 29,  59,  83, 255},
        {  1,  18,  33, 255}, {127, 219, 202, 255},
        { 29,  59,  83, 180}, {128, 164, 194, 255},
    },
    /* Cobalt2 — vibrant deep ocean cobalt with bright gold and turquoise */
    { "Cobalt2",
        { 25,  53,  73, 255}, {225, 235, 245, 255}, {255, 198,   0, 255},
        {165, 255, 144, 255}, {  0, 232, 198, 255},
        { 18,  40,  56, 255}, {115, 148, 175, 255},
        { 18,  38,  54, 255}, { 30,  64,  88, 255}, { 40,  85, 118, 255},
        { 18,  38,  54, 255}, {158, 255, 255, 255},
        { 40,  85, 118, 180}, {255, 198,   0, 255},
    },
    /* Material Ocean — deep ocean with electric cyan and amber */
    { "Material Ocean",
        { 15,  17,  26, 255}, {143, 147, 162, 255}, {255, 203, 107, 255},
        {195, 232, 141, 255}, {137, 221, 255, 255},
        { 24,  26,  42, 255}, { 75,  87, 120, 255},
        { 11,  13,  20, 255}, { 24,  26,  42, 255}, { 38,  42,  68, 255},
        { 11,  13,  20, 255}, {137, 221, 255, 255},
        { 38,  42,  68, 180}, {255, 204,   0, 255},
    },
    /* Poimandres — cool teal on stormy deep navy */
    { "Poimandres",
        { 26,  30,  40, 255}, {166, 172, 205, 255}, {252, 197, 233, 255},
        { 93, 228, 199, 255}, {137, 221, 255, 255},
        { 36,  42,  56, 255}, {118, 124, 153, 255},
        { 22,  25,  34, 255}, { 36,  42,  56, 255}, { 48,  55,  74, 255},
        { 22,  25,  34, 255}, {166, 172, 205, 255},
        { 48,  55,  74, 180}, { 93, 228, 199, 255},
    },
    ...
    /* Bioluminescence — abyss deep navy with glowing neon sea life */
    { "Bioluminescence",
        { 10,  17,  24, 255}, {224, 242, 241, 255}, {105, 240, 174, 255},
        {255,  82,  82, 255}, {  0, 229, 255, 255},
        { 18,  30,  42, 255}, {100, 145, 155, 255},
        {  7,  12,  17, 255}, { 18,  30,  42, 255}, { 28,  52,  70, 255},
        {  7,  12,  17, 255}, {105, 240, 174, 255},
        { 28,  52,  70, 185}, {224,  64, 251, 255},
    },
    ...
    /* --- Purples, Rose & Synthwave --- */
    /* Shades of Purple — vibrant royal purple with sunshine yellow and neon mint */
    { "Shades of Purple",
        { 45,  43,  85, 255}, {240, 235, 255, 255}, {250, 208,   0, 255},
        {165, 255, 144, 255}, {158, 255, 255, 255},
        { 30,  30,  63, 255}, {165, 153, 233, 255},
        { 30,  30,  63, 255}, { 55,  50, 105, 255}, { 77,  33, 252, 255},
        { 30,  30,  63, 255}, {165, 153, 233, 255},
        { 77,  33, 252, 180}, {251, 148, 255, 255},
    },
    /* Rose Pine Moon — soft rosy violets */
    { "Rose Pine Moon",
    ...
    /* Rose Pine Dawn — warm light floral pastels */
    { "Rose Pine Dawn",
        {250, 244, 237, 255}, { 87,  82, 121, 255}, { 40,  34,  64, 255},
        {180,  99, 122, 255}, {144, 122, 169, 255},
        {242, 233, 222, 255}, {152, 147, 165, 255},
        {244, 236, 227, 255}, {235, 223, 210, 255}, {206, 195, 215, 255},
        {244, 236, 227, 255}, {180,  99, 122, 255},
        {206, 195, 215, 180}, {215, 130, 126, 255},
    },
    /* LaserWave — 80s synthwave with hot pink and pearl aqua */
    { "LaserWave",
        { 39,  33,  46, 255}, {245, 240, 250, 255}, {235, 100, 185, 255},
        {116, 223, 196, 255}, { 64, 180, 196, 255},
        { 49,  42,  58, 255}, {145, 136, 155, 255},
        { 25,  21,  30, 255}, { 49,  42,  58, 255}, { 65,  54,  78, 255},
        { 25,  21,  30, 255}, {179, 129, 197, 255},
        { 65,  54,  78, 180}, {255, 226,  97, 255},
    },
    ...
    /* Synthwave '84 — glowing neon sunset on deep midnight violet */
    { "Synthwave '84",
        { 36,   0,  55, 255}, {255, 255, 255, 255}, {243, 231,  15, 255},
        {255,   0, 127, 255}, {  0, 240, 255, 255},
        { 54,   0,  82, 255}, {170, 120, 210, 255},
        { 24,   0,  37, 255}, { 54,   0,  82, 255}, { 88,   0, 134, 255},
        { 24,   0,  37, 255}, {  0, 240, 255, 255},
        { 88,   0, 134, 180}, {255,   0, 255, 255},
    },
    /* Miami Sunset — 80s South Beach art deco neon */
    { "Miami Sunset",
        { 20,  17,  38, 255}, {240, 237, 246, 255}, {255,  64, 129, 255},
        {  0, 229, 255, 255}, {255, 145,   0, 255},
        { 34,  28,  62, 255}, {150, 138, 180, 255},
        { 14,  12,  27, 255}, { 34,  28,  62, 255}, { 60,  45, 105, 255},
        { 14,  12,  27, 255}, {  0, 229, 255, 255},
        { 60,  45, 105, 180}, {255, 234,   0, 255},
    },
    /* Horizon Dark — warm neon cyberpunk with coral-pink and electric cyan */
    { "Horizon Dark",
        { 28,  30,  38, 255}, {213, 216, 218, 255}, {233,  86, 120, 255},
        { 41, 211, 152, 255}, { 38, 187, 217, 255},
        { 36,  39,  50, 255}, {108, 111, 126, 255},
        { 22,  23,  30, 255}, { 36,  39,  50, 255}, { 46,  50,  64, 255},
        { 22,  23,  30, 255}, {250, 183, 149, 255},
        { 46,  50,  64, 180}, {250, 183, 149, 255},
    },

    /* --- High-Chroma, Cyber & Neon --- */
    /* Cyberpunk 2077 — neon yellow, electric emerald, and laser scarlet */
    { "Cyberpunk 2077",
        {  8,   8,  12, 255}, {236, 239, 244, 255}, {252, 238,  10, 255},
        {  0, 255, 136, 255}, {  0, 240, 255, 255},
        { 22,  20,  32, 255}, {120, 115, 140, 255},
        {  5,   5,   8, 255}, { 25,  22,  38, 255}, { 48,  36,  80, 255},
        {  5,   5,   8, 255}, {  0, 240, 255, 255},
        { 48,  36,  80, 190}, {255,   0,  60, 255},
    },
    ...
    /* Vibrant Ink — punchy jet black with neon accents */
    { "Vibrant Ink",
        { 15,  15,  15, 255}, {255, 255, 255, 255}, {255, 102,   0, 255},
        {102, 255,   0, 255}, { 68, 180, 204, 255},
        { 28,  28,  28, 255}, {150, 150, 150, 255},
        {  8,   8,   8, 255}, { 30,  30,  30, 255}, { 50,  50,  50, 255},
        {  8,   8,   8, 255}, {255, 204,   0, 255},
        { 55,  55,  55, 190}, {255, 255,   0, 255},
    },
    /* Prismatic Dark — pure black ground with vibrant spectral hues */
    { "Prismatic Dark",
        { 12,  11,  16, 255}, {245, 245, 250, 255}, {255,  51, 102, 255},
        {  0, 230, 118, 255}, { 41, 121, 255, 255},
        { 26,  24,  35, 255}, {145, 140, 170, 255},
        {  8,   7,  11, 255}, { 26,  24,  35, 255}, { 50,  40,  75, 255},
        {  8,   7,  11, 255}, {213,   0, 249, 255},
        { 50,  40,  75, 190}, {255, 214,   0, 255},
    },
    /* Solar Flare — blazing gold, hot crimson, and plasma turquoise */
    { "Solar Flare",
        { 26,  15,  26, 255}, {255, 243, 224, 255}, {255, 213,  79, 255},
        {255,  23,  68, 255}, { 24, 255, 255, 255},
        { 42,  24,  40, 255}, {165, 130, 155, 255},
        { 18,  10,  18, 255}, { 42,  24,  40, 255}, { 72,  36,  64, 255},
        { 18,  10,  18, 255}, {255, 110,  64, 255},
        { 72,  36,  64, 190}, {255, 110,  64, 255},
    },

    /* --- Soft Pastels & Warm Paper --- */
    /* Fairyfloss — pastel candy rainbow on soft plum purple */
    { "Fairyfloss",
        { 70,  52, 101, 255}, {248, 248, 242, 255}, {255, 133, 127, 255},
        {176, 198, 121, 255}, {168, 225, 220, 255},
        { 85,  63, 122, 255}, {197, 180, 227, 255},
        { 53,  39,  77, 255}, { 85,  63, 122, 255}, {108,  80, 155, 255},
        { 53,  39,  77, 255}, {241, 207, 138, 255},
        {108,  80, 155, 180}, {241, 207, 138, 255},
    },
    ...
    /* Candy Pop — playful colorful light theme with saturated sweets */
    { "Candy Pop",
        {255, 245, 248, 255}, { 53,  32,  59, 255}, {233,  30,  99, 255},
        {  0, 191, 165, 255}, { 41, 121, 255, 255},
        {243, 229, 245, 255}, {145, 125, 155, 255},
        {252, 232, 239, 255}, {243, 218, 230, 255}, {225, 190, 220, 255},
        {252, 232, 239, 255}, {233,  30,  99, 255},
        {225, 190, 220, 180}, {255, 109,   0, 255},
    },
    ...
    /* --- British Premier League (EPL) Clubs --- */
    /* EPL: Arsenal — Emirates Stadium red, gold, and white */
    { "EPL: Arsenal",
        { 22,  18,  24, 255}, {245, 245, 248, 255}, {239,   1,   7, 255},
        {156, 130,  74, 255}, { 30, 144, 255, 255},
        { 36,  26,  32, 255}, {155, 140, 150, 255},
        { 16,  12,  18, 255}, { 36,  26,  32, 255}, { 80,  15,  25, 255},
        { 16,  12,  18, 255}, {239,   1,   7, 255},
        { 80,  15,  25, 180}, {239,   1,   7, 255},
    },
    /* EPL: Aston Villa — Villa Park claret, sky blue, and lion gold */
    { "EPL: Aston Villa",
        { 24,  14,  20, 255}, {245, 242, 248, 255}, {149, 191, 229, 255},
        {254, 230,   0, 255}, {149, 191, 229, 255},
        { 42,  20,  34, 255}, {160, 135, 150, 255},
        { 16,   9,  14, 255}, { 42,  20,  34, 255}, {103,  14,  54, 255},
        { 16,   9,  14, 255}, {149, 191, 229, 255},
        {103,  14,  54, 180}, {149, 191, 229, 255},
    },
    /* EPL: Bournemouth — Vitality cherry red and black */
    { "EPL: Bournemouth",
        { 16,  16,  18, 255}, {245, 245, 245, 255}, {218,  41,  28, 255},
        {218, 175, 105, 255}, {255,  85,  75, 255},
        { 30,  24,  26, 255}, {140, 135, 135, 255},
        { 10,  10,  12, 255}, { 30,  24,  26, 255}, { 60,  15,  18, 255},
        { 10,  10,  12, 255}, {218,  41,  28, 255},
        { 60,  15,  18, 190}, {218,  41,  28, 255},
    },
    /* EPL: Brentford — The Bees red, white, and honey gold */
    { "EPL: Brentford",
        { 18,  16,  16, 255}, {248, 248, 248, 255}, {227,   6,  19, 255},
        {254, 225,   0, 255}, {255, 100,  80, 255},
        { 34,  24,  24, 255}, {150, 140, 140, 255},
        { 12,  10,  10, 255}, { 34,  24,  24, 255}, { 70,  16,  20, 255},
        { 12,  10,  10, 255}, {254, 225,   0, 255},
        { 70,  16,  20, 180}, {254, 225,   0, 255},
    },
    /* EPL: Brighton & Hove — Seagulls blue and sun yellow */
    { "EPL: Brighton & Hove",
        { 12,  22,  38, 255}, {240, 246, 255, 255}, {  0, 140, 255, 255},
        {255, 205,   0, 255}, { 80, 185, 255, 255},
        { 18,  34,  58, 255}, {115, 145, 180, 255},
        {  8,  16,  28, 255}, { 18,  34,  58, 255}, { 25,  60, 110, 255},
        {  8,  16,  28, 255}, {255, 205,   0, 255},
        { 25,  60, 110, 180}, {255, 205,   0, 255},
    },
    /* EPL: Chelsea — Stamford Bridge royal blue and gold */
    { "EPL: Chelsea",
        { 10,  20,  44, 255}, {245, 248, 255, 255}, { 40, 120, 240, 255},
        {219, 161,  17, 255}, { 90, 170, 255, 255},
        { 16,  32,  70, 255}, {120, 145, 190, 255},
        {  6,  13,  30, 255}, { 16,  32,  70, 255}, {  3,  70, 148, 255},
        {  6,  13,  30, 255}, {219, 161,  17, 255},
        {  3,  70, 148, 180}, {219, 161,  17, 255},
    },
    /* EPL: Crystal Palace — Selhurst Park blue and claret */
    { "EPL: Crystal Palace",
        { 16,  20,  34, 255}, {240, 244, 252, 255}, {196,  18,  46, 255},
        { 60, 130, 240, 255}, { 80, 160, 255, 255},
        { 26,  32,  56, 255}, {135, 145, 175, 255},
        { 10,  13,  24, 255}, { 26,  32,  56, 255}, { 55,  30,  70, 255},
        { 10,  13,  24, 255}, {196,  18,  46, 255},
        { 55,  30,  70, 180}, {196,  18,  46, 255},
    },
    /* EPL: Everton — Goodison Park royal blue and amber */
    { "EPL: Everton",
        { 10,  24,  52, 255}, {248, 250, 255, 255}, { 70, 150, 255, 255},
        {255, 201,  40, 255}, {100, 180, 255, 255},
        { 18,  38,  80, 255}, {130, 160, 205, 255},
        {  6,  16,  36, 255}, { 18,  38,  80, 255}, { 30,  70, 150, 255},
        {  6,  16,  36, 255}, {248, 250, 255, 255},
        { 30,  70, 150, 180}, {255, 201,  40, 255},
    },
    /* EPL: Fulham — Craven Cottage black, white, and red */
    { "EPL: Fulham",
        { 14,  14,  16, 255}, {250, 250, 252, 255}, {220,  20,  30, 255},
        {180, 180, 185, 255}, {255,  75,  85, 255},
        { 28,  28,  32, 255}, {145, 145, 150, 255},
        {  8,   8,  10, 255}, { 28,  28,  32, 255}, { 50,  50,  58, 255},
        {  8,   8,  10, 255}, {220,  20,  30, 255},
        { 50,  50,  58, 180}, {220,  20,  30, 255},
    },
    /* EPL: Hull City — The Tigers amber and black */
    { "EPL: Hull City",
        { 18,  14,  10, 255}, {248, 245, 240, 255}, {241, 138,   1, 255},
        {255, 180,  40, 255}, {255, 150,  20, 255},
        { 34,  26,  18, 255}, {160, 140, 120, 255},
        { 12,   9,   6, 255}, { 34,  26,  18, 255}, { 75,  45,  12, 255},
        { 12,   9,   6, 255}, {241, 138,   1, 255},
        { 75,  45,  12, 180}, {241, 138,   1, 255},
    },
    /* EPL: Ipswich Town — Portman Road blue and crimson */
    { "EPL: Ipswich Town",
        { 12,  22,  44, 255}, {248, 250, 255, 255}, { 60, 140, 245, 255},
        {222,  44,  55, 255}, { 90, 175, 255, 255},
        { 20,  34,  68, 255}, {125, 150, 190, 255},
        {  8,  15,  32, 255}, { 20,  34,  68, 255}, { 30,  60, 120, 255},
        {  8,  15,  32, 255}, {222,  44,  55, 255},
        { 30,  60, 120, 180}, {222,  44,  55, 255},
    },
    /* EPL: Leicester City — King Power blue and turmeric gold */
    { "EPL: Leicester City",
        { 10,  22,  48, 255}, {245, 248, 255, 255}, {253, 190,  17, 255},
        { 60, 140, 245, 255}, { 80, 170, 255, 255},
        { 18,  34,  74, 255}, {130, 155, 195, 255},
        {  6,  15,  34, 255}, { 18,  34,  74, 255}, { 25,  55, 120, 255},
        {  6,  15,  34, 255}, {253, 190,  17, 255},
        { 25,  55, 120, 180}, {253, 190,  17, 255},
    },
    /* EPL: Liverpool — Anfield red, gold, and Persian teal */
    { "EPL: Liverpool",
        { 24,  10,  14, 255}, {250, 245, 245, 255}, {215,  25,  45, 255},
        {  0, 178, 169, 255}, {246, 235,  97, 255},
        { 42,  18,  24, 255}, {165, 130, 135, 255},
        { 16,   6,   9, 255}, { 42,  18,  24, 255}, { 80,  15,  25, 255},
        { 16,   6,   9, 255}, {  0, 178, 169, 255},
        { 80,  15,  25, 180}, {246, 235,  97, 255},
    },
    /* EPL: Manchester City — Etihad sky blue, white, and navy */
    { "EPL: Manchester City",
        { 14,  24,  44, 255}, {240, 248, 255, 255}, {108, 171, 221, 255},
        {255, 199,  88, 255}, {130, 195, 245, 255},
        { 22,  38,  70, 255}, {135, 160, 190, 255},
        {  9,  16,  30, 255}, { 22,  38,  70, 255}, { 35,  65, 110, 255},
        {  9,  16,  30, 255}, {108, 171, 221, 255},
        { 35,  65, 110, 180}, {108, 171, 221, 255},
    },
    /* EPL: Manchester United — Old Trafford Red Devil red and gold */
    { "EPL: Manchester United",
        { 18,  14,  16, 255}, {248, 245, 245, 255}, {218,  41,  28, 255},
        {255, 229,   0, 255}, {255,  85,  70, 255},
        { 36,  22,  25, 255}, {155, 135, 135, 255},
        { 12,   9,  10, 255}, { 36,  22,  25, 255}, { 75,  18,  20, 255},
        { 12,   9,  10, 255}, {255, 229,   0, 255},
        { 75,  18,  20, 180}, {255, 229,   0, 255},
    },
    /* EPL: Newcastle United — St James' Park black, white, and gold */
    { "EPL: Newcastle United",
        { 15,  16,  18, 255}, {255, 255, 255, 255}, {240, 184,  61, 255},
        { 65, 182, 230, 255}, { 85, 195, 245, 255},
        { 28,  30,  34, 255}, {150, 150, 155, 255},
        {  9,  10,  12, 255}, { 28,  30,  34, 255}, { 45,  50,  60, 255},
        {  9,  10,  12, 255}, {240, 184,  61, 255},
        { 45,  50,  60, 180}, {240, 184,  61, 255},
    },
    /* EPL: Nottingham Forest — City Ground Garibaldi red and gold */
    { "EPL: Nottingham Forest",
        { 22,  12,  14, 255}, {250, 248, 248, 255}, {221,   0,   0, 255},
        {228, 164,   0, 255}, {255,  80,  80, 255},
        { 38,  18,  22, 255}, {155, 130, 135, 255},
        { 14,   8,   9, 255}, { 38,  18,  22, 255}, { 75,  15,  20, 255},
        { 14,   8,   9, 255}, {228, 164,   0, 255},
        { 75,  15,  20, 180}, {221,   0,   0, 255},
    },
    /* EPL: Southampton — St Mary's red, white, and halo yellow */
    { "EPL: Southampton",
        { 19,  12,  14, 255}, {248, 246, 246, 255}, {215,  25,  32, 255},
        {255, 194,  14, 255}, {255,  90,  95, 255},
        { 34,  20,  24, 255}, {150, 130, 135, 255},
        { 12,   8,   9, 255}, { 34,  20,  24, 255}, { 68,  18,  24, 255},
        { 12,   8,   9, 255}, {255, 194,  14, 255},
        { 68,  18,  24, 180}, {255, 194,  14, 255},
    },
    /* EPL: Tottenham Hotspur — Lilywhite, cockerel cyan, and deep navy */
    { "EPL: Tottenham Hotspur",
        { 10,  18,  44, 255}, {255, 255, 255, 255}, { 80, 170, 255, 255},
        {180, 200, 230, 255}, {100, 190, 255, 255},
        { 18,  32,  72, 255}, {130, 150, 190, 255},
        {  6,  12,  30, 255}, { 18,  32,  72, 255}, { 28,  55, 120, 255},
        {  6,  12,  30, 255}, {255, 255, 255, 255},
        { 28,  55, 120, 180}, { 80, 170, 255, 255},
    },
    /* EPL: West Ham United — London Stadium claret and sky blue */
    { "EPL: West Ham United",
        { 26,  12,  18, 255}, {246, 242, 248, 255}, { 27, 177, 231, 255},
        {243, 212,  76, 255}, { 45, 190, 245, 255},
        { 46,  20,  30, 255}, {160, 135, 148, 255},
        { 17,   8,  12, 255}, { 46,  20,  30, 255}, {122,  38,  58, 255},
        { 17,   8,  12, 255}, { 27, 177, 231, 255},
        {122,  38,  58, 180}, { 27, 177, 231, 255},
    },
    /* EPL: Wolverhampton — Molineux old gold and black */
    { "EPL: Wolverhampton",
        { 14,  14,  16, 255}, {250, 248, 242, 255}, {253, 185,  19, 255},
        {255, 215,  90, 255}, {255, 170,  10, 255},
        { 28,  26,  24, 255}, {160, 145, 125, 255},
        {  8,   8,   9, 255}, { 28,  26,  24, 255}, { 65,  48,  12, 255},
        {  8,   8,   9, 255}, {253, 185,  19, 255},
        { 65,  48,  12, 190}, {253, 185,  19, 255},
    },

    /* --- NBA Basketball Teams (All 30 Teams) --- */
    /* NBA: Atlanta Hawks — torch red, volt green, and legacy black */
    { "NBA: Atlanta Hawks",
        { 20,  18,  20, 255}, {248, 248, 248, 255}, {224,  58,  62, 255},
        {193, 211,  47, 255}, {255,  85,  90, 255},
        { 36,  26,  30, 255}, {150, 140, 145, 255},
        { 12,  10,  12, 255}, { 36,  26,  30, 255}, { 80,  20,  24, 255},
        { 12,  10,  12, 255}, {193, 211,  47, 255},
        { 80,  20,  24, 180}, {224,  58,  62, 255},
    },
    /* NBA: Boston Celtics — TD Garden green, clover gold, and white */
    { "NBA: Boston Celtics",
        { 12,  20,  15, 255}, {245, 250, 246, 255}, {  0, 195,  85, 255},
        {186, 150,  83, 255}, { 80, 220, 130, 255},
        { 20,  36,  26, 255}, {130, 160, 140, 255},
        {  8,  14,  10, 255}, { 20,  36,  26, 255}, {  0,  90,  38, 255},
        {  8,  14,  10, 255}, {186, 150,  83, 255},
        {  0,  90,  38, 180}, {  0, 195,  85, 255},
    },
    /* NBA: Brooklyn Nets — Barclays Center pure black and white */
    { "NBA: Brooklyn Nets",
        { 14,  14,  14, 255}, {255, 255, 255, 255}, {255, 255, 255, 255},
        {160, 162, 165, 255}, {200, 202, 205, 255},
        { 28,  28,  28, 255}, {140, 142, 145, 255},
        {  8,   8,   8, 255}, { 28,  28,  28, 255}, { 48,  48,  48, 255},
        {  8,   8,   8, 255}, {220, 220, 220, 255},
        { 48,  48,  48, 180}, {255, 255, 255, 255},
    },
    /* NBA: Charlotte Hornets — Buzz City teal, purple, and cool gray */
    { "NBA: Charlotte Hornets",
        { 12,  18,  28, 255}, {240, 246, 250, 255}, {  0, 205, 215, 255},
        {165, 120, 240, 255}, {  0, 215, 230, 255},
        { 22,  30,  48, 255}, {130, 145, 175, 255},
        {  8,  12,  20, 255}, { 22,  30,  48, 255}, { 35,  55,  95, 255},
        {  8,  12,  20, 255}, {  0, 205, 215, 255},
        { 35,  55,  95, 180}, {  0, 205, 215, 255},
    },
    /* NBA: Chicago Bulls — United Center iconic red and black */
    { "NBA: Chicago Bulls",
        { 18,  14,  16, 255}, {250, 248, 248, 255}, {225,  25,  75, 255},
        {206,  17,  65, 255}, {255,  80, 110, 255},
        { 36,  20,  24, 255}, {160, 135, 140, 255},
        { 10,   8,   9, 255}, { 36,  20,  24, 255}, { 80,  15,  25, 255},
        { 10,   8,   9, 255}, {225,  25,  75, 255},
        { 80,  15,  25, 180}, {225,  25,  75, 255},
    },
    /* NBA: Cleveland Cavaliers — Wine and gold with midnight navy */
    { "NBA: Cleveland Cavaliers",
        { 20,  12,  22, 255}, {248, 245, 248, 255}, {253, 187,  48, 255},
        {210,  30,  90, 255}, {255, 195,  65, 255},
        { 38,  18,  32, 255}, {160, 135, 150, 255},
        { 12,   7,  14, 255}, { 38,  18,  32, 255}, { 90,  15,  45, 255},
        { 12,   7,  14, 255}, {253, 187,  48, 255},
        { 90,  15,  45, 180}, {253, 187,  48, 255},
    },
    /* NBA: Dallas Mavericks — American Airlines royal blue and silver */
    { "NBA: Dallas Mavericks",
        { 10,  20,  36, 255}, {242, 246, 252, 255}, { 40, 140, 240, 255},
        {184, 196, 202, 255}, { 80, 180, 255, 255},
        { 18,  32,  56, 255}, {130, 150, 180, 255},
        {  6,  14,  26, 255}, { 18,  32,  56, 255}, { 20,  60, 115, 255},
        {  6,  14,  26, 255}, {184, 196, 202, 255},
        { 20,  60, 115, 180}, { 40, 140, 240, 255},
    },
    /* NBA: Denver Nuggets — Mile High sunshine gold, navy, and flatirons red */
    { "NBA: Denver Nuggets",
        { 14,  22,  40, 255}, {245, 248, 255, 255}, {254, 197,  36, 255},
        {220,  45,  65, 255}, { 65, 155, 245, 255},
        { 24,  36,  64, 255}, {135, 155, 185, 255},
        {  9,  15,  28, 255}, { 24,  36,  64, 255}, { 35,  60, 105, 255},
        {  9,  15,  28, 255}, {254, 197,  36, 255},
        { 35,  60, 105, 180}, {254, 197,  36, 255},
    },
    /* NBA: Detroit Pistons — Motor City royal blue and scarlet */
    { "NBA: Detroit Pistons",
        { 12,  18,  36, 255}, {245, 248, 255, 255}, { 40, 120, 245, 255},
        {225,  25,  55, 255}, { 70, 160, 255, 255},
        { 20,  30,  58, 255}, {130, 150, 185, 255},
        {  8,  12,  26, 255}, { 20,  30,  58, 255}, { 28,  55, 115, 255},
        {  8,  12,  26, 255}, {225,  25,  55, 255},
        { 28,  55, 115, 180}, { 40, 120, 245, 255},
    },
    /* NBA: Golden State Warriors — Bay Area royal blue and California gold */
    { "NBA: Golden State Warriors",
        { 12,  20,  42, 255}, {245, 248, 255, 255}, {255, 199,  44, 255},
        { 80, 165, 255, 255}, {255, 215,  85, 255},
        { 20,  32,  68, 255}, {135, 155, 190, 255},
        {  8,  14,  30, 255}, { 20,  32,  68, 255}, { 29,  66, 138, 255},
        {  8,  14,  30, 255}, {255, 199,  44, 255},
        { 29,  66, 138, 180}, {255, 199,  44, 255},
    },
    /* NBA: Houston Rockets — Space City red and silver */
    { "NBA: Houston Rockets",
        { 18,  14,  16, 255}, {248, 246, 246, 255}, {225,  25,  75, 255},
        {196, 206, 212, 255}, {255,  80, 110, 255},
        { 34,  22,  26, 255}, {155, 135, 140, 255},
        { 11,   8,   9, 255}, { 34,  22,  26, 255}, { 75,  18,  25, 255},
        { 11,   8,   9, 255}, {225,  25,  75, 255},
        { 75,  18,  25, 180}, {225,  25,  75, 255},
    },
    /* NBA: Indiana Pacers — Gainbridge navy, yellow, and silver */
    { "NBA: Indiana Pacers",
        { 10,  20,  42, 255}, {246, 248, 255, 255}, {253, 187,  48, 255},
        {188, 196, 202, 255}, { 80, 160, 255, 255},
        { 18,  32,  66, 255}, {130, 150, 185, 255},
        {  7,  14,  30, 255}, { 18,  32,  66, 255}, { 25,  55, 110, 255},
        {  7,  14,  30, 255}, {253, 187,  48, 255},
        { 25,  55, 110, 180}, {253, 187,  48, 255},
    },
    /* NBA: LA Clippers — Intuit Dome clipper red and royal blue */
    { "NBA: LA Clippers",
        { 14,  18,  30, 255}, {245, 248, 252, 255}, {225,  25,  55, 255},
        { 50, 130, 245, 255}, { 80, 165, 255, 255},
        { 22,  28,  48, 255}, {135, 145, 175, 255},
        {  9,  12,  20, 255}, { 22,  28,  48, 255}, { 35,  55,  95, 255},
        {  9,  12,  20, 255}, {225,  25,  55, 255},
        { 35,  55,  95, 180}, {225,  25,  55, 255},
    },
    /* NBA: Los Angeles Lakers — ShowTime purple and gold */
    { "NBA: Los Angeles Lakers",
        { 24,  14,  36, 255}, {248, 245, 252, 255}, {253, 185,  39, 255},
        {175, 110, 235, 255}, {255, 205,  75, 255},
        { 42,  24,  62, 255}, {160, 135, 175, 255},
        { 16,   9,  24, 255}, { 42,  24,  62, 255}, { 85,  37, 131, 255},
        { 16,   9,  24, 255}, {253, 185,  39, 255},
        { 85,  37, 131, 180}, {253, 185,  39, 255},
    },
    /* NBA: Memphis Grizzlies — Grind City Beale Street blue and gold */
    { "NBA: Memphis Grizzlies",
        { 14,  18,  36, 255}, {242, 246, 255, 255}, {115, 153, 198, 255},
        {253, 185,  39, 255}, {140, 180, 230, 255},
        { 22,  30,  58, 255}, {130, 150, 185, 255},
        {  9,  12,  25, 255}, { 22,  30,  58, 255}, { 35,  55, 105, 255},
        {  9,  12,  25, 255}, {253, 185,  39, 255},
        { 35,  55, 105, 180}, {253, 185,  39, 255},
    },
    /* NBA: Miami Heat — South Beach heat red and Floridian gold */
    { "NBA: Miami Heat",
        { 20,  10,  16, 255}, {250, 246, 246, 255}, {225,  25,  65, 255},
        {249, 160,  27, 255}, {255,  85, 115, 255},
        { 38,  18,  26, 255}, {160, 130, 140, 255},
        { 13,   6,  10, 255}, { 38,  18,  26, 255}, { 85,  15,  30, 255},
        { 13,   6,  10, 255}, {249, 160,  27, 255},
        { 85,  15,  30, 180}, {249, 160,  27, 255},
    },
    /* NBA: Milwaukee Bucks — Deer District forest green and cream */
    { "NBA: Milwaukee Bucks",
        { 12,  22,  16, 255}, {245, 248, 245, 255}, { 80, 185, 110, 255},
        {238, 225, 198, 255}, { 40, 165, 235, 255},
        { 20,  38,  28, 255}, {130, 155, 140, 255},
        {  8,  15,  11, 255}, { 20,  38,  28, 255}, {  0,  71,  27, 255},
        {  8,  15,  11, 255}, {238, 225, 198, 255},
        {  0,  71,  27, 180}, { 80, 185, 110, 255},
    },
    /* NBA: Minnesota Timberwolves — Target Center midnight navy and aurora green */
    { "NBA: Minnesota Timberwolves",
        { 12,  24,  42, 255}, {245, 248, 255, 255}, {120, 190,  32, 255},
        { 55, 145, 215, 255}, {140, 215,  50, 255},
        { 20,  36,  64, 255}, {130, 155, 185, 255},
        {  8,  16,  28, 255}, { 20,  36,  64, 255}, { 25,  55, 105, 255},
        {  8,  16,  28, 255}, {120, 190,  32, 255},
        { 25,  55, 105, 180}, {120, 190,  32, 255},
    },
    /* NBA: New Orleans Pelicans — Crescent City navy, gold, and red */
    { "NBA: New Orleans Pelicans",
        { 12,  24,  42, 255}, {246, 246, 250, 255}, {215, 180, 120, 255},
        {225,  25,  55, 255}, {235, 200, 140, 255},
        { 20,  36,  64, 255}, {135, 150, 180, 255},
        {  8,  16,  28, 255}, { 20,  36,  64, 255}, { 25,  55, 105, 255},
        {  8,  16,  28, 255}, {215, 180, 120, 255},
        { 25,  55, 105, 180}, {215, 180, 120, 255},
    },
    /* NBA: New York Knicks — Madison Square Garden blue and Manhattan orange */
    { "NBA: New York Knicks",
        { 12,  20,  38, 255}, {245, 248, 255, 255}, {245, 132,  38, 255},
        { 60, 160, 255, 255}, {255, 160,  75, 255},
        { 20,  32,  60, 255}, {130, 150, 185, 255},
        {  8,  13,  25, 255}, { 20,  32,  60, 255}, {  0,  85, 160, 255},
        {  8,  13,  25, 255}, {245, 132,  38, 255},
        {  0,  85, 160, 180}, {245, 132,  38, 255},
    },
    /* NBA: Oklahoma City Thunder — Paycom Center thunder blue and sunset orange */
    { "NBA: Oklahoma City Thunder",
        { 10,  22,  40, 255}, {245, 248, 255, 255}, {  0, 150, 235, 255},
        {239,  59,  36, 255}, { 60, 175, 255, 255},
        { 18,  34,  64, 255}, {130, 155, 185, 255},
        {  7,  15,  28, 255}, { 18,  34,  64, 255}, {  0,  70, 140, 255},
        {  7,  15,  28, 255}, {239,  59,  36, 255},
        {  0,  70, 140, 180}, {  0, 150, 235, 255},
    },
    /* NBA: Orlando Magic — Kia Center magic blue, silver, and black */
    { "NBA: Orlando Magic",
        { 12,  16,  26, 255}, {245, 248, 255, 255}, { 40, 150, 240, 255},
        {196, 206, 212, 255}, { 80, 180, 255, 255},
        { 20,  28,  44, 255}, {135, 145, 170, 255},
        {  8,  11,  18, 255}, { 20,  28,  44, 255}, {  0,  85, 155, 255},
        {  8,  11,  18, 255}, { 40, 150, 240, 255},
        {  0,  85, 155, 180}, { 40, 150, 240, 255},
    },
    /* NBA: Philadelphia 76ers — Wells Fargo Center blue and crimson red */
    { "NBA: Philadelphia 76ers",
        { 12,  20,  38, 255}, {245, 248, 255, 255}, {237,  23,  76, 255},
        { 60, 160, 255, 255}, {255,  75, 115, 255},
        { 20,  32,  60, 255}, {130, 150, 185, 255},
        {  8,  13,  25, 255}, { 20,  32,  60, 255}, {  0,  75, 150, 255},
        {  8,  13,  25, 255}, {237,  23,  76, 255},
        {  0,  75, 150, 180}, {237,  23,  76, 255},
    },
    /* NBA: Phoenix Suns — Footprint Center sunburst orange and purple */
    { "NBA: Phoenix Suns",
        { 22,  14,  34, 255}, {248, 245, 250, 255}, {249, 120,  30, 255},
        {249, 173,  27, 255}, {255, 150,  60, 255},
        { 38,  24,  58, 255}, {155, 135, 170, 255},
        { 14,   9,  22, 255}, { 38,  24,  58, 255}, { 75,  30, 110, 255},
        { 14,   9,  22, 255}, {249, 120,  30, 255},
        { 75,  30, 110, 180}, {249, 120,  30, 255},
    },
    /* NBA: Portland Trail Blazers — Moda Center Rip City red and black */
    { "NBA: Portland Trail Blazers",
        { 16,  14,  16, 255}, {250, 250, 250, 255}, {224,  58,  62, 255},
        {180, 180, 180, 255}, {255,  85,  90, 255},
        { 32,  24,  26, 255}, {150, 140, 140, 255},
        { 10,   9,  10, 255}, { 32,  24,  26, 255}, { 70,  18,  22, 255},
        { 10,   9,  10, 255}, {224,  58,  62, 255},
        { 70,  18,  22, 180}, {224,  58,  62, 255},
    },
    /* NBA: Sacramento Kings — Golden 1 Center kings purple and granite gray */
    { "NBA: Sacramento Kings",
        { 20,  14,  30, 255}, {248, 245, 252, 255}, {175, 110, 235, 255},
        {150, 160, 170, 255}, {195, 140, 245, 255},
        { 36,  24,  52, 255}, {150, 135, 165, 255},
        { 13,   9,  20, 255}, { 36,  24,  52, 255}, { 90,  45, 129, 255},
        { 13,   9,  20, 255}, {175, 110, 235, 255},
        { 90,  45, 129, 180}, {175, 110, 235, 255},
    },
    /* NBA: San Antonio Spurs — Frost Bank Center silver and black */
    { "NBA: San Antonio Spurs",
        { 14,  14,  16, 255}, {245, 245, 248, 255}, {230, 235, 240, 255},
        {160, 165, 170, 255}, {  0, 178, 169, 255},
        { 28,  28,  32, 255}, {140, 142, 148, 255},
        {  8,   8,  10, 255}, { 28,  28,  32, 255}, { 50,  50,  58, 255},
        {  8,   8,  10, 255}, {230, 235, 240, 255},
        { 50,  50,  58, 180}, {  0, 178, 169, 255},
    },
    /* NBA: Toronto Raptors — Scotiabank Arena red, silver, and gold */
    { "NBA: Toronto Raptors",
        { 18,  14,  16, 255}, {248, 246, 246, 255}, {225,  25,  75, 255},
        {180, 151,  90, 255}, {255,  80, 110, 255},
        { 34,  22,  26, 255}, {155, 135, 140, 255},
        { 11,   8,   9, 255}, { 34,  22,  26, 255}, { 75,  18,  25, 255},
        { 11,   8,   9, 255}, {180, 151,  90, 255},
        { 75,  18,  25, 180}, {225,  25,  75, 255},
    },
    /* NBA: Utah Jazz — Delta Center jazz gold, green, and mountain navy */
    { "NBA: Utah Jazz",
        { 10,  20,  38, 255}, {246, 248, 255, 255}, {249, 160,  27, 255},
        { 60, 175, 100, 255}, {255, 185,  75, 255},
        { 18,  32,  60, 255}, {130, 150, 180, 255},
        {  7,  13,  25, 255}, { 18,  32,  60, 255}, { 25,  55, 105, 255},
        {  7,  13,  25, 255}, {249, 160,  27, 255},
        { 25,  55, 105, 180}, {249, 160,  27, 255},
    },
    /* NBA: Washington Wizards — Capital One Arena navy, red, and silver */
    { "NBA: Washington Wizards",
        { 10,  20,  40, 255}, {245, 248, 255, 255}, {227,  24,  55, 255},
        {196, 206, 212, 255}, { 70, 160, 255, 255},
        { 18,  32,  64, 255}, {130, 150, 185, 255},
        {  7,  14,  28, 255}, { 18,  32,  64, 255}, { 25,  55, 110, 255},
        {  7,  14,  28, 255}, {227,  24,  55, 255},
        { 25,  55, 110, 180}, {227,  24,  55, 255},
    },
};
...
static int theme_find(const char* name)
{
    ...
    /* 2. Match skipping "EPL: " or "NBA: " prefix in either query or theme name */
    for (int i = 0; i < G_THEME_COUNT; ++i) {
        const char* a = g_themes[i].name;
        if (strncmp(a, "EPL: ", 5) == 0 || strncmp(a, "NBA: ", 5) == 0) a += 5;
        const char* b = name;
        if (strncmp(b, "EPL: ", 5) == 0 || strncmp(b, "epl: ", 5) == 0 ||
            strncmp(b, "NBA: ", 5) == 0 || strncmp(b, "nba: ", 5) == 0) b += 5;
        while (*a && *b) {
            char ca = (*a >= 'A' && *a <= 'Z') ? (char)(*a + 32) : *a;
            char cb = (*b >= 'A' && *b <= 'Z') ? (char)(*b + 32) : *b;
            if (ca != cb) break;
